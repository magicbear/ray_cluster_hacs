# Ray Cluster Integration for Home Assistant
...
使用说明 Instructions
====
让 Home Assistant 支持 Ray Cluster 设备的 HACS 插件
...
仓库地址：`https://github.com/magicbear/ray_cluster_hacs`

类别选择：`集成` Category: `Integration`

3. 点击添加按钮。

4. 添加完成后，通过右下角添加集成进行安装，再进入集成页面添加集成，搜索`Ray Cluster`就可以添加集成并进行设置。
